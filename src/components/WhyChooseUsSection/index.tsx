  ...
  return (
    <div className="mt-16 bg-lunabella-cream dark:bg-lunabella-dark/50 rounded-lg p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {/* Punto 1: Crianza Etica y Familiar */}
        <div className="text-center">
          ...
          <h3 className="text-lg font-semibold mb-2">Crianza Etica y Familiar</h3>
          <p className="text-sm text-muted-foreground">
            Nuestros cachorros nacen y crecen en nuestro hogar, recibiendo amor y socializacion
            temprana.
          </p>
        </div>
        {/* Punto 2: Salud y Genetica Premium */}
        <div className="text-center">
          <div className="bg-lunabella-gold text-lunabella-cream w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
            <ShieldCheck className="w-8 h-8" />
          </div>
          <h3 className="text-lg font-semibold mb-2">Salud y Genetica Premium</h3>
          <p className="text-sm text-muted-foreground">
