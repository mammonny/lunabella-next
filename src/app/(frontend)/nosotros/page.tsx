  ...
  return (
    <>
      ...
      <main className="isolate">
        ...
        {/* CTA Section - Same style as nuestros-perros and individual dog pages */}
        <section className="relative py-28 md:py-40 overflow-hidden bg-lunabella-diagonal">
          <div className="relative container mx-auto px-6 lg:px-12">
            <div className="max-w-4xl mx-auto text-center">
              <div className="flex items-center justify-center gap-4 mb-8">
              ...
              <h2 className="text-display text-4xl md:text-5xl lg:text-6xl text-gray-900 mb-8">
                ¿Buscas un{' '}
                <span className="text-gradient-gold">cachorro</span>?
              </h2>
              ...
              {/* CTA Buttons - exact same style as other pages */}
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/nuestros-perros" className="btn-lunabella-outline">
